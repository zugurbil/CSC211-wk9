...
public class CurvedActivityDemo
{
   public static void main(String[] args)
   {
      ...
      CurvedActivity curvedExam =
                 new CurvedActivity(curvePercent);      //*************creates CurvedActivity obj**************************

      // Set the exam score.
      curvedExam.setScore(score);      //****super's attribute is set*****
      ...
      System.out.println("To string of obj curvedExam " +curvedExam.toString());
